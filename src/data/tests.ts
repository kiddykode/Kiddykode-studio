...
export const flashCardSets: FlashCardSet[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        options: ['A True or False value', 'A number', 'A text string', 'A list'],
        optionsFr: ['Une valeur True ou False', 'Un nombre', 'Une chaîne de texte', 'Une liste'],
        correctIndex: 0,
        category: 'basics',
        difficulty: 'beginner',
      },
      {
        ...
        options: ['Python shows an error', 'It works fine', 'Python ignores it', 'It becomes a number'],
        optionsFr: ['Python affiche une erreur', 'Ça fonctionne bien', 'Python l\'ignore', 'Ça devient un nombre'],
        correctIndex: 0,
        category: 'basics',
        difficulty: 'beginner',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        options: ['Yes, just assign a new value', 'No, never', 'Only if it\'s a number', 'Only once'],
        optionsFr: ['Oui, il suffit d\'assigner une nouvelle valeur', 'Non, jamais', 'Seulement si c\'est un nombre', 'Une seule fois'],
        correctIndex: 0,
        category: 'variables',
        difficulty: 'beginner',
      },
      {
        ...
        optionsFr: ['String (Chaîne)', 'Integer (Entier)', 'Float', 'Boolean (Booléen)'],
        correctIndex: 0,
        category: 'variables',
        difficulty: 'beginner',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        optionsFr: ['continue', 'skip', 'next', 'pass'],
        correctIndex: 0,
        category: 'loops',
        difficulty: 'intermediate',
      },
      {
        ...
        options: ['Numbers 1, 2, 3, 4', 'Numbers 1, 2, 3, 4, 5', 'Numbers 0, 1, 2, 3, 4', 'Numbers 0, 1, 2, 3, 4, 5'],
        optionsFr: ['Les nombres 1, 2, 3, 4', 'Les nombres 1, 2, 3, 4, 5', 'Les nombres 0, 1, 2, 3, 4', 'Les nombres 0, 1, 2, 3, 4, 5'],
        correctIndex: 0,
        category: 'loops',
        difficulty: 'intermediate',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        options: ['len(my_list)', 'my_list.size()', 'my_list.count()', 'my_list.length'],
        optionsFr: ['len(my_list)', 'my_list.size()', 'my_list.count()', 'my_list.length'],
        correctIndex: 0,
        category: 'lists',
        difficulty: 'beginner',
      },
      {
        ...
        options: ['The last item in the list', 'The first item', 'An error', 'Nothing'],
        optionsFr: ['Le dernier élément de la liste', 'Le premier élément', 'Une erreur', 'Rien'],
        correctIndex: 0,
        category: 'lists',
        difficulty: 'beginner',
      },
      {
        ...
        options: ['list.remove(item)', 'list.delete(item)', 'del list.item', 'list.pop(item)'],
        optionsFr: ['list.remove(item)', 'list.delete(item)', 'del list.item', 'list.pop(item)'],
        correctIndex: 0,
        category: 'lists',
        difficulty: 'beginner',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        answer: 'Yes',
        answerFr: 'Yes',
        options: ['Yes', 'True', 'Nothing', 'Error'],
        optionsFr: ['Yes', 'True', 'Rien', 'Erreur'],
        correctIndex: 0,
        category: 'conditionals',
        difficulty: 'beginner',
      },
      {
        ...
        options: ['Yes, as many as needed', 'No, only one', 'Only two', 'Only with else'],
        optionsFr: ['Oui, autant que nécessaire', 'Non, un seul', 'Seulement deux', 'Seulement avec else'],
        correctIndex: 0,
        category: 'conditionals',
        difficulty: 'beginner',
      },
      {
        ...
        options: ['Shows which code belongs to the if', 'Makes code faster', 'Is optional', 'Creates a comment'],
        optionsFr: ['Montre quel code appartient au if', 'Rend le code plus rapide', 'Est optionnel', 'Crée un commentaire'],
        correctIndex: 0,
        category: 'conditionals',
        difficulty: 'beginner',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        options: ['3.333... (a float)', '3 (an integer)', '1', '30'],
        optionsFr: ['3.333... (un float)', '3 (un entier)', '1', '30'],
        correctIndex: 0,
        category: 'arithmetic',
        difficulty: 'beginner',
      },
      {
        ...
        options: ['Exponentiation (power)', 'Multiplication', 'Double asterisk comment', 'Error'],
        optionsFr: ['Exponentiation (puissance)', 'Multiplication', 'Commentaire double astérisque', 'Erreur'],
        correctIndex: 0,
        category: 'arithmetic',
        difficulty: 'beginner',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        answer: 'False',
        answerFr: 'False',
        options: ['False', 'True', 'Error', 'NotTrue'],
        optionsFr: ['False', 'True', 'Erreur', 'NotTrue'],
        correctIndex: 0,
        category: 'logical',
        difficulty: 'intermediate',
      },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        options: ['Less than', 'Greater than', 'Equal to', 'Not equal to'],
        optionsFr: ['Inférieur à', 'Supérieur à', 'Égal à', 'Différent de'],
        correctIndex: 0,
        category: 'comparison',
        difficulty: 'beginner',
      },
      ...
      },
      {
        ...
        options: ['Less than or equal to', 'Greater than or equal to', 'Not equal to', 'Assignment'],
        optionsFr: ['Inférieur ou égal à', 'Supérieur ou égal à', 'Différent de', 'Affectation'],
        correctIndex: 0,
        category: 'comparison',
        difficulty: 'beginner',
      },
